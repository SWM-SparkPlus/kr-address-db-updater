...
| ---- | ---------- | ------------------------- | ---- | ---- | --- | -------------------------------------------------------------------- |
| 1    | 관리번호   | manage_number             | 25   | 문자 | PK  | FK                                                                   |
| 2    | 도로명코드 | roadname_code             | 12   | 문자 |     | 도로명주소 테이블. 참고용                                            |
| 3    | 우편번호   | zipcode                   | 5    | 문자 |     | 도로명주소 테이블(기초구역번호). 우편번호 맵핑용                     |
| 4    | 시도명     | sido                      | 20   | 문자 |     | 도로명코드 테이블. 도로명주소 생성용                                 |
| 5    | 시군구명   | sigungu                   | 20   | 문자 |     | 도로명코드 테이블. 도로명주소 생성용                                 |
| 6    | 읍면동명   | eupmyeondong              | 20   | 문자 |     | 도로명코드 테이블(법정음면동). 도로명주소 생성용. 법정읍면동과 동일. |
| 7    | 법정리명   | bupjungli                 | 20   | 문자 |     | 지번주소 테이블. 도로명주소 생성용                                   |
| 8    | 도로명     | roadname                  | 80   | 문자 |     | 도로명코드 테이블. 도로명주소 생성용                                 |
